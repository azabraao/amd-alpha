<?php
  ...
  require_once('classes/seleciona_dados_relatorio.php');

  require_once('classes/valida_session.php');
  $objValida = new Session();
  $objValida->validaRelatorio($_SESSION['id_usuario'], $_GET['id']);
...
<html lang="pt-br">
  ...
  <body>
    ...
    <?php
      $objRel = new Relatorio();
      $objRel->selecionaDadosBasicos();
    ?>
