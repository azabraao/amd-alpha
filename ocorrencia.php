<?php
  ...
  require_once('classes/seleciona_ocorrencias.php');  
  require_once('classes/valida_session.php');
  $objValida = new Session();
  $objValida->validaOcorrencia($_SESSION['id_usuario'], $_GET['id']);
...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3" id="ocorrencia">
          <?php
            $objOc = new Ocorrencias();
            $objOc->selecionaOcorrencia();
          ?>
        </div>
      </div>
    </div>
